...
Next session: **TOPIC CONFIRMED AND LINKS AVAILABLE SOON**. 

<!-- Registration link and ZOOM link will be posted soon. -->

<!-- Registration to the event [here](https://www.eventbrite.com/e/r-in-grenoble-git-in-r-for-beginners-tickets-152812388969). -->

<!-- Link to Zoom [here](https://univ-grenoble-alpes-fr.zoom.us/j/95046952189?pwd=SWRScVljekZ0V1NBUHFmVlJFMXJ3Zz09). -->
...
(abstract strongly inspired by the intro from happygitwithr.com)", 
  ...
  "27/05/2021", "New presentation TBA", "Abstract to come", "XXX",
...
- Git in R for befinners: [video](), [slides](presentation/git-github/git_for_beginners.html)
