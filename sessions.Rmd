...
Next session: **Reproducible research with R**, on **September 26th from 16:00 to 18:00 @IMAG**. You can register to the event [here](https://www.eventbrite.fr/e/billets-r-user-group-session-21-reproducible-research-in-r-73099756339).
...
You can also print [**program poster coming soon**] <!-- [this poster](poster.pdf) --> and put it up somewhere at work.
